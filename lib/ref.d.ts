...
declare module "ref" {
	...
	export function writeUInt64LE(buffer: Buffer, offset: number, input: number): void;
	/** Write a little-endian unsigned 64-bit int. */
	export function writeUInt64LE(buffer: Buffer, offset: number, input: string): void;
